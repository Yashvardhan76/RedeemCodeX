...
//    private val typeOptions = mutableListOf(JTab.Type.CODE, JTab.Type.TEMPLATE)
//    private val modifyOptions: MutableList<String> = mutableListOf(
//        JTab.Modify.ENABLED,
//        JTab.Modify.LOCKED,
...
//    private val genOptions = mutableListOf(JTab.Generate.AMOUNT)
...
//                        if (cachedCodes.isNotEmpty()) completions.add(JTab.Delete.All.value)
//                    }
//
...
//                        when (args[1]) {
//                            JTab.Type.Code.value -> if (sender.hasPermission(JPermission.Admin.DELETE)) completions.addAll(
//                                cachedCodes.filter { it !in args })
//
//                            JTab.Type.Template.value -> if (sender.hasPermission(JPermission.Admin.DELETE)) completions.addAll(
//                                cachedTemplate.filter { it !in args })
//                        }
//                    }
//                }
//
...
//
//            5 -> {
//                if (args[0] == JTab.GeneralActions.Gen.value && args[1] == JTab.Type.Code.value && args[2].toIntOrNull() != null) completions.add(
//                    JTab.Generate.Amount.value
//                )
//                when (args[0]) {
//                    JTab.GeneralActions.Delete.value -> {
//                        when (args[1]) {
//                            JTab.Type.Code.value -> if (sender.hasPermission(JPermission.Admin.DELETE)) completions.addAll(cachedCodes.filter {
//                                it !in args
//                            })
//
//                            JTab.Type.Template.value -> if (sender.hasPermission(JPermission.Admin.DELETE)) completions.addAll(cachedTemplate.filter {
//                                it !in args
//                            })
//                        }
//                    }
//                }
//                val editList = mutableListOf(JTab.Modify.Edit.REWARD, JTab.Modify.Edit.MESSAGE, JTab.Modify.Edit.SOUND)
//                if (sender.hasPermission(JPermission.Admin.MODIFY)) {
//                    when (args[3]) {
//                        JTab.Modify.EDIT -> if (sender.hasPermission(JPermission.Admin.MODIFY)) completions.addAll(editList)
//                    }
//                }
//
//            }
...
//                }
//                when (args[2]) {
//                    JTab.Modify.REMOVE_TARGET -> if (sender.hasPermission(JPermission.Admin.MODIFY)) {
//                        val list = cachedTargetList[args[1]] ?: mutableListOf()
//                        completions.addAll(list)
//                    }
//
//                    JTab.Modify.SET_TARGET, JTab.Modify.ADD_TARGET -> if (sender.hasPermission(JPermission.Admin.MODIFY)) {
//                        return null
//                    }
//                }
//            }
...
//            else -> {
//                if (sender.hasPermission(JPermission.Admin.MODIFY)) {
//                    if (args[2].contains(JTab.Modify.SET_TARGET) || args[2].contains(JTab.Modify.ADD_TARGET)) {
//                        return null
//                    }
//                }
//                //Deletion Cached Codes Endless
//                if (args[0] == JTab.GeneralActions.Delete.value && args[1] == JTab.Type.Code.value) {
//                    completions.addAll(cachedCodes.filter { it !in args })
//                }
//                if (args[0] == JTab.GeneralActions.Delete.value && args[1] == JTab.Type.Template.value) {
//                    completions.addAll(cachedTemplate.filter { it !in args })
//                }
//            }
//        }
//
